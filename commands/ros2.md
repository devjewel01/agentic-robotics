...
Quick reference for ROS2 CLI. For full skill coverage see `skills/ros2/SKILL.md`.

## Build System (colcon)

| Action              | Command                                      | Description                                                |
| ------------------- | -------------------------------------------- | ---------------------------------------------------------- |
| **Build Workspace** | `colcon build --symlink-install`             | Build all packages (symlink allows Python edits without rebuild) |
...
| **Check Env**      | `printenv` then `grep ROS`     | Check ROS environment vars  |
...
| **Doctor**      | `ros2 doctor`                       | Check for system issues and misconfig     |
